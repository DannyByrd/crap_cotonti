...
$L['cfg_preset_params'] = 'handy: Удобный без слеша в конце, handyslash: Удобный со слешом в конце, handyhtml: Удобный c .html в конце, compat: Совместимый с Genoa/Seditio, custom: Собственный urltrans.dat, none: Отключено';
