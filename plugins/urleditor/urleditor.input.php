...
if(file_exists(cot_incfile('urleditor', 'plug', 'functions.' . $cfg['plugin']['urleditor']['preset']))){
	require_once cot_incfile('urleditor', 'plug', 'functions.' . $cfg['plugin']['urleditor']['preset']);
} else {
