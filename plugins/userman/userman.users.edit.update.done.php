...
//	    um_gropus_idu($id, $member, $tempgroups, true );
	...
	$message = $L['userman'];
	$message .= um_build_string($L['um_access_user_edit'],$urr['user_name'],$L['um_access_goto']);
...
//	$message = $L['userman'];
//	$message .= um_build_string($L['um_user_access'],$urr['user_name'],$L['um_access_updated']);
//	cot_message($message,'warning');	
}