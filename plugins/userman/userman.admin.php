...
$temp->assign(array(	'UM_TITLE' => $L['title'],
						'UM_SUBTITLE' => $L['subtitle'],
						'UM_USERS_CREATE_ID' => $urr['user_id'], 
						'UM_NAME' => cot_inputbox('text', 'um_username', $cfg['plugin']['userman']['defaultname'].$sufix, array('size' => 32, 'maxlength' => 100) + $protected),
						'UM_USERS_CREATE_EMAIL' => cot_inputbox('text', 'um_useremail', $sufixemail, array('size' => 32, 'maxlength' => 64)),
						'UM_USERS_CREATE_MONEY' => cot_inputbox('text','um_usermoney'),
...
$L['userman_help'] = $L['userman_help_main']; 
} 

$adminhelp = $L['userman_help'];
