...
{
	if($rverify = cot_import('rverify', 'P', 'INT')){
	...
	$out['mcaptcha_verifying'] = cot_captcha_generate();
	$out['mcaptcha_verifyinginput'] = cot_inputbox('text', 'rverify', '', 'size="10" maxlength="20"');
