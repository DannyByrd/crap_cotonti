<!-- BEGIN: MAIN -->
    ...
    <!-- BEGIN: LIST_ROW -->
        <div class="portlet blue-hoki box <!-- IF {LIST_ROW_BOLD} > 0 --> adbold<!-- ENDIF --><!-- IF {LIST_ROW_VIP} > 0 --> eventip<!-- ENDIF -->">
            ...
            <div class="portlet-body">
                <div class="row static-info">
                    ...
                    <div class="col-md-8 name">
                        ...
                        <!-- ENDIF -->
                        <p style="margin: 7px 0px 0px 14px;"><i class="icon-time"></i> {LIST_ROW_DATE_STAMP|cot_date('Y-m-d',$this)}</p>
                    </div>
