...
<!-- BEGIN: ITEM -->
					<tr>
						<td colspan="2" class="{PLUGIN_BOARDRES_TITLE}">
						{PLUGIN_BOARDRES_TITLE}</td>
					</tr>
					<tr>
						<td colspan="2" class="{PLUGIN_BOARDRES_ODDEVEN}">
						{PLUGIN_BOARDRES_TEXT}</td>
					</tr>
					<tr>
						<td class="{PLUGIN_BOARDRES_ODDEVEN} width50"><p class="small">{PHP.L.plu_last_date}: {PLUGIN_PRODUCTSRES_TIME}</p></td>
