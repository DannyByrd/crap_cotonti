...
<body>
	...
	<ul id="user" class="body">
		...
		<li><a href="{PHP.cfg.mainurl}" target="_blank" title="{PHP.L.hea_viewsite}"><!-- IF {PHP.cfg.maintitle} && {PHP.cfg.maintitle|mb_strlen} < 50 -->{PHP.cfg.maintitle} <!-- ELSE -->{PHP.L.hea_viewsite} <!-- ENDIF --></a></li>
	</ul>
