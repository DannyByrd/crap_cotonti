...
<!-- BEGIN: MAIN -->
		...
		<div class="block">
			...
			<table class="cells">
				...
				<tr>
					<td>Seo title:</td>
					<td>{ADMIN_STRUCTURE_SEOTITLE}</td>
				</tr>
				<tr>
					<td>Meta описание:</td>
					<td>{ADMIN_STRUCTURE_METADESC}</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2">{ADMIN_STRUCTURE_TEXT}</td>
				</tr>
				<tr>
					<td>{PHP.L.Icon}:</td>
				...
				<tr>
					...
					<!-- IF {PHP.cot_plugins_active.mavatars} -->
						{ADMIN_STRUCTURE_EDIT_FORM_MAVATAR}
					<!-- ELSE -->
						<span style="color: #b94a48;">Плагин <a style="color: #b94a48;" href="{PHP|cot_url('admin', 'm=extensions&a=details&pl=mavatars')}" target="_blank"><b>mavatars</b></a> не установлен</span> 
					<!-- ENDIF -->
					</td>
				</tr>
				<tr>
		...
		<div class="block">
			...
			<table class="cells info">
				...
				<tr>
					...
					<td> 
				<!-- IF {PHP.cot_plugins_active.mavatars} -->
					<span style="color: #b94a48;">Можно добавить только в созданную категорию</span> 
				<!-- ELSE -->
				<span style="color: #b94a48;">Плагин <a style="color: #b94a48;" href="{PHP|cot_url('admin', 'm=extensions&a=details&pl=mavatars')}" target="_blank"><b>mavatars</b></a> не установлен</span> 
				<!-- ENDIF -->
					</td>
