 ...
 * @param string $cats Serilized array
 * @return bool
 *
 * @global CotDB $db
 */
function cot_extrafield_add($location, $name, $type, $html='', $variants='', $default='', $required=false, $parse='HTML', $description='', $params = '', $enabled = 1, $noalter = false, $customtype = '', $cats)
{
	...
	$extf['field_cats'] = is_null($cats) ? '' : $cats;
 ...
 * @global CotDB $db
 */
function cot_extrafield_update($location, $oldname, $name, $type, $html='', $variants='', $default='', $required=0, $parse='HTML', $description='', $params = '', $enabled = 1, $customtype = '', $cats)
{
	global $db, $db_extra_fields;
