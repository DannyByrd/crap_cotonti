...
$L['adm_structure_seotitle_required'] = 'Не задано поле: Seo Title';
...
$L['adm_extrafield_select_cats'] = "Категории (только для типа 'filter')";
...
$L['adm_extrafield_selectable_values'] = 'Значения для select, radio, checklistbox, filter (через запятую)';
