<!-- BEGIN: MAIN -->
		...
		<div class="block">
			<h2 class="blogs">{POSTADD_FIRMTITLE}</h2>
			{FILE "{PHP.cfg.themes_dir}/{PHP.cfg.defaulttheme}/warnings.tpl"}
			<div class="customform">
				<form action="{POSTADD_FORM_SEND}" enctype="multipart/form-data" method="post" name="blogsform">
					<table class="cells">
						<tr>
	...
	<!-- END: TAGS -->
						...
						<tr>
							<td>{PHP.L.post_addr}:</td>
							<td>{POSTADD_FORM_ADDR}</td>
						</tr>
						<tr>
							<td>{PHP.L.post_phone}:</td>
							<td>{POSTADD_FORM_PHONE}</td>
						</tr>
						<tr>
							<td>{PHP.L.post_skype}:</td>
							<td>{POSTADD_FORM_SKYPE}</td>
						</tr>
						<tr>
							<td>{PHP.L.post_site}:</td>
							<td>{POSTADD_FORM_SITE}</td>
						</tr>
						<tr>
							<td>{PHP.L.post_email}:</td>
							<td>{POSTADD_FORM_EMAIL}</td>
						</tr>
						<tr>
