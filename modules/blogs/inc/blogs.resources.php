...
$R['post_submitnewblogs'] = '<a href="{$sub_url}" rel="nofollow">'.$L['post_submitnewpost'].'</a>';
...
$R['post_more'] =' <span class="readmore"><a href="{$post_url}" title="'.$L['ReadMore'].'">'.$L['ReadMore'].'</a></span>';