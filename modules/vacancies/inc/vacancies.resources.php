...
$R['vac_submitnewvacancies'] = '<a href="{$sub_url}" rel="nofollow">'.$L['vac_submitnewvac'].'</a>';
...
$R['list_more'] =' <span class="readmore"><a href="{$vac_url}" title="'.$L['ReadMore'].'">'.$L['ReadMore'].'</a></span>';