		...
		<div class="block">
			...
			<form action="{PAGEEDIT_FORM_SEND}" enctype="multipart/form-data" method="post" name="pageform">
				<table class="cells">
					...
					<tr>
						<td class="width30">{PHP.L.Show_in_categories}:</td>
						<td class="width70">{PAGEEDIT_FORM_CATS_TO_SHOW}</td>
					</tr>
					<tr>
						<td>{PHP.L.Title}:</td>
...
<!-- END: FILTERS -->
					...
					<tr>
						<td>Экстраполе Dowload:</td>
						<td>{PAGEEDIT_FORM_DOWNLOAD}</td>
					</tr>	
					<tr>
						<td>Экстраполе ALTERNATE1:</td>
						<td>{PAGEEDIT_FORM_ALTERNATE1}</td>
					</tr>	
					<tr>
		...
		<script type="text/javascript">
				...
				$('#addField').live("click",function(){
					...
					var object = $('.alt_list').clone().prependTo(".boo");
