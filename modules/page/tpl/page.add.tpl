			...
			<form action="{PAGEADD_FORM_SEND}" enctype="multipart/form-data" method="post" name="pageform">
				<table class="cells">
					...
					<tr>
						...
						<td class="width70">{PAGEADD_FORM_CATS_TO_SHOW}</td>
					</tr>
					<tr>
						<td>{PHP.L.Title}:</td>
...
<!-- END: FILTERS -->
					...
					<tr>
						...
						<td>Экстраполе ALT_EN_US:</td>
						<td>{PAGEADD_FORM_ALT_EN_US}</td>
					</tr>
				
					<tr>
						<td>Экстраполе Dowload:</td>
						<td>{PAGEADD_FORM_DOWNLOAD}</td>
					</tr>
