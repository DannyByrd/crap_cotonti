...
$R['rez_submitnewrezume'] = '<a href="{$sub_url}" rel="nofollow">'.$L['rez_submitnewREZ'].'</a>';
...
$R['list_more'] =' <span class="readmore"><a href="{$rez_url}" title="'.$L['ReadMore'].'">'.$L['ReadMore'].'</a></span>';