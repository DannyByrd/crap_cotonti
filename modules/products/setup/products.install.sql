...
CREATE TABLE IF NOT EXISTS `cot_products` (
  ...
  `prd_desc` MEDIUMTEXT collate utf8_unicode_ci default NULL,
  ...
  `prd_text` TEXT collate utf8_unicode_ci NOT NULL,
...
('products', 'auto', '1', '', 'Автомобили', 'Автомобили', '', '', '', 0, 0),
('products', 'pc', '2', '', 'Компьютерная техника', 'Компьютерная техника', '', '', '', 0, 0),
('products', 'byt', '3', '', 'Бытовая техника', 'Бытовая техника', '', '', '', 0, 0),
('products', 'sport', '4', '', 'Спортивные товары', 'Спортивные товары', '', '', '', 0, 0),
('products', 'home', '5', '', 'Товары для дома', 'Товары для дома', '', '', '', 0, 0),
('products', 'build', '6', '', 'Строительные материалы', 'Строительные материалы', '', '', '', 0, 0),
('products', 'tools', '7', '', 'Инструменты', 'Инструменты', '', '', '', 0, 0),
('products', 'prom', '8', '', 'Промышленные товары', 'Промышленные товары', '', '', '', 0, 0);
