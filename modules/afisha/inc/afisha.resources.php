...
$R['event_submitnewafisha'] = '<a href="{$sub_url}" rel="nofollow">'.$L['event_submitnewevent'].'</a>';
...
$R['event_more'] =' <span class="readmore"><a href="{$event_url}" title="'.$L['ReadMore'].'">'.$L['ReadMore'].'</a></span>';