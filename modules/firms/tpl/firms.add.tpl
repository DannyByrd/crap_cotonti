<!-- BEGIN: MAIN -->
		...
		<div class="block">
			<h2 class="firms">{FIRMADD_FIRMTITLE}</h2>
...
<!-- ENDIF -->
						...
						<tr>
							<td>{PHP.L.firm_desc}:</td>
							<td>{FIRMADD_FORM_DESC}</td>
						</tr>
						<tr>
							<td>{PHP.L.Alias}:</td>
	...
	<!-- END: TAGS -->
				...
				<!-- ENDIF -->
						...
						<tr>
							<td colspan="2" class="valid">
								...
								<button type="submit" name="rfirmtate" value="0">{PHP.L.Publish}</button>
								<!-- ENDIF -->
								<button type="submit" name="rfirmtate" value="2" class="submit">{PHP.L.Saveasdraft}</button>
								<button type="submit" name="rfirmtate" value="1">{PHP.L.Submitforapproval}</button>
							</td>
						</tr>
					</table>
				</form>
		...
		<div class="help">{PHP.L.firm_formhint}</div>
