...
/* === Hook === */
foreach (cot_getextplugins('firms.list.first') as $pl)
{
	include $pl;
}
/* ===== */
...
/* === Hook === */
foreach (cot_getextplugins('firms.list.query') as $pl)
{
	include $pl;
}
/* ===== */
...
/* === Hook === */
foreach (cot_getextplugins('firms.list.main') as $pl)
{
	include $pl;
}
/* ===== */
...
$t->assign(array('LIST_GOTOMAP_URL' => cot_url('map', 'c='.$c)));
...
$jj = 0;
/* === Hook - Part1 : Set === */
$extp = cot_getextplugins('firms.list.loop');
/* ===== */
$sqllist_rowset = $sqllist->fetchAll();

$sqllist_rowset_other = false;
/* === Hook === */
foreach (cot_getextplugins('firms.list.before_loop') as $pl)
{
	include $pl;
}
/* ===== */
...
/* === Hook === */
foreach (cot_getextplugins('firms.list.tags') as $pl)
{
	include $pl;
}
/* ===== */
