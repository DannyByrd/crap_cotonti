...
('core','theme','01','forcedefaulttheme',3,'1','1','',''),
...
CREATE TABLE `cot_extra_fields` (
  ...
  `field_cats` text collate utf8_unicode_ci NOT NULL,
...
CREATE TABLE `cot_structure` (
  ...
  `structure_seotitle` varchar(128) collate utf8_unicode_ci NOT NULL,
  `structure_desc` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `structure_text` text COLLATE utf8_unicode_ci NOT NULL,
  `structure_metadesc` mediumtext COLLATE utf8_unicode_ci NOT NULL,
