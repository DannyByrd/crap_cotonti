...
$cfg['defaulttheme'] = 'tiuportal';	// Default theme code. Be SURE it's pointing to a valid folder in ./themes/... !!
$cfg['defaultthemesecond'] = 'nemesis';
...
$ignore_pages_by_al = array(
    'ignore-this-page-by_alias',
);

// for which page acept second theme
$cfg['aceptsecondtheme'] = array(
	array(
		'm' 	=> 'add',
	),
	array(
